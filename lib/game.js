...
Game = function(gameObj, player1Name, player2Name, settings) {
  ...
  this.conf = _.extend({}, DEFAULT_SETTINGS, settings);
  this.id = gameObj;
  this.turn = 1;
  this.player1 = new Player(player1Name);
  this.player2 = new Player(player2Name);
  this.terrain = new Terrain(null, this.conf.width, this.conf.height, this.conf.skinTiles);

  this.player1.skin = 1;
  this.player2.skin = 2;
  this.player1.position = this.conf.positions.p1;
  this.player2.position = this.conf.positions.p2;
